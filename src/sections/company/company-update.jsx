  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.put(
        `${Onrun}/api/company/${updateModalData.id}/`,
        updateModalData,
        {
          headers: {
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                required
                onChange={(e) =>
                  setUpdateModalData({ ...updateModalData, national_id: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                required
                onChange={(e) =>
                  setUpdateModalData({ ...updateModalData, telephone: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                required
                onChange={(e) =>
                  setUpdateModalData({ ...updateModalData, registration_number: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                required
                onChange={(e) =>
                  setUpdateModalData({ ...updateModalData, website: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                required
                onChange={(e) =>
                  setUpdateModalData({ ...updateModalData, register_capital: e.target.value })
                }
              />
            </Grid>
